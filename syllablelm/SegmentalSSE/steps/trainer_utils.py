...
def save_progress(self):
    self.total_progress.append([self.progress['epoch'], self.progress['num_updates'], self.progress['best_step'], self.progress['best_acc'], self.progress['best_f1'], self.progress['rec_of_bestf1'], self.progress['prec_of_bestf1'], time.time() - self.start_time])
...
def setup_progress(self):
    ...
    progress['best_f1'] = 0
    progress['rec_of_bestf1'] = 0
    progress['prec_of_bestf1'] = 0
    ...
    if self.args.resume:
        ...
        with open(progress_pkl, "rb") as f:
            ...
            progress['epoch'], progress['num_updates'], progress['best_step'], progress['best_acc'], progress['best_f1'], progress['rec_of_bestf1'], progress['prec_of_bestf1'], _ = total_progress[-1]
        ...
        logger.info("  best_seg_f1 = %s" % progress['best_f1'])
        logger.info("  prec_of_bestf1 = %s" % progress['prec_of_bestf1'])
        logger.info("  rec_of_bestf1 = %s" % progress['rec_of_bestf1'])
