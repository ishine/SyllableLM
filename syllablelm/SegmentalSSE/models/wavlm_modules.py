...
class TransformerEncoder_wavlm(nn.Module):
    def __init__(self, args):
        super().__init__()
        self.layer_use = args.encoder_layers - 1
        ...
        self.layers = nn.ModuleList(
            [
                TransformerSentenceEncoderLayer_wavlm(
    ...
    def extract_features(self, x, padding_mask=None, need_head_weights=False, tgt_layer=None, all_hidden_states=False, pre_feats=False):
        ...
        for i, layer in enumerate(self.layers):
            ...
            if True:
                x, z, pos_bias = layer(x, self_attn_padding_mask=padding_mask, need_weights=need_head_weights,
...
class TransformerSentenceEncoderLayer_wavlm(nn.Module):
    """
    ...
    def __init__(
        ...
        self.self_attn = MultiheadAttention_wavlm(
            self.embedding_dim,
            num_attention_heads,
...
def init_bert_params(module):
    ...
    if isinstance(module, MultiheadAttention) or isinstance(module, MultiheadAttention_wavlm):
